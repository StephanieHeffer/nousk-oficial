...
<ul class="slide">
<li id="ferramentas" class="img linkimg"><p class="especial-title breakword especial-martop"><?php the_title(); the_content();?></p></li>
<?php
$args = array(
...
?>
<li id="<?php echo $titulotratado; ?>" class="img linkimg"><p class="especial-title breakword especial-martop"><?php the_title(); the_content(); ?></p></li>
