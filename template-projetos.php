...
<ul class="slide">
<li id="projetos"><p class="especial-title breakword especial-martop"><?php the_title(); the_content();?></p></li>
<?php
$args = array(
    'post_type'         => 'projeto',
    'post_status'       => 'publish',
...
?>
<li id="<?php echo $titulotratado; ?>" class="img"><p class="especial-title breakword especial-martop"><?php the_title(); the_content(); ?></p></li>
